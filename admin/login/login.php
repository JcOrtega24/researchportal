        ...
        <div class="card">
          <div class="card-body" id="margin-top">
            ...
            <form action="" method="POST" name="Form" onsubmit="return validateForm()">
              <div class="md-form">
                <input type="text" class="form-control validate" id="username" name="username" placeholder="Your username">
                <label data-error="wrong" data-success="right"></label>
              </div>

              <div class="md-form">

                <input type="password" class="form-control validate" id="myInput" name="password" placeholder="Your Password">
              ...
              <!-- Comment out create free account -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-info">
            <h3>ARELLANO UNIVERSITY RESEARCH PORTAL</h3>
