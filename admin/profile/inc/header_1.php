...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container">
      <div class="logo float-left">
        <a href="/CustomLandingPage/index.php" class="scrollto"><img src="../../resource/img/logo.png" alt="" class="img-fluid">&nbsp;<strong>ARELLANO UNIVERSITY RESEARCH PORTAL</strong></a>
      </div>
  ...
  <script src="../../../resource/lib/easing/easing.min.js">
    < /script <script src="./.. / resource / lib / mobile - nav / mobile - nav.js >
  </script>
